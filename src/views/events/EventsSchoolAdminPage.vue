                        ...
                        <tbody v-if="!esCompartibleLista">
                            <tr v-for="r in recursosNoCompartido" :key="r.id">
                                ...
                                <td>
                                    ...
                                    <button class="btn-modify-lock" v-if="r.bloqueado"
                                        @click.stop="bloquearRecurso(r.recursos, false)">
                                        🔒
                                    </button>
                                    <button v-else class="btn-modify-unlock"
                                        @click.stop="bloquearRecurso(r.recursos, true)">
                                        🔓
                                    </button>
                                </td>
                            </tr>
                ...
                <ion-col size="12">
                    <ion-item>
                        ...
                        <ion-select v-model="selectedConstante" @ionChange="onConstanteChange">
                            <ion-select-option v-for="constante in constantes" :key="constante.clave"
                                :value="constante">
                                {{ constante.clave }}
                            </ion-select-option>
                        </ion-select>
